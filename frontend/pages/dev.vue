...
<script setup lang="ts">
    ...
    //  --- Meta information
    definePageMeta( { order: 2, label: 'Teknisk Profil', seo: { title: 'LMCS - Teknisk Profil', description: 'Kristoffer Gjøsund (Krigjo25) - Utvikler som forenkler det komplekse. Se min sanntids GitHub-aktivitet, akademiske reise og tekniske logger fra .NET til filosofi.', author: 'Kristoffer Gjøsund', ogTitle: 'Teknisk Profil - Kristoffer Gjøsund', ogDescription: 'Kristoffer Gjøsund (Krigjo25) - Utvikler som forenkler det komplekse. Se min sanntids GitHub-aktivitet, akademiske reise og tekniske logger fra .NET til filosofi.', ogImage: 'https://krigjo25.no/media/images/carousel/20240903_165612.jpg',ogUrl: 'https://krigjo25.no', ogType: 'website', ogLocale: 'nb_NO', twitterCard: 'summary_large_image', twitterTitle: 'LMCS - Teknisk Profil', twitterDescription: 'Kristoffer Gjøsund (Krigjo25) - Utvikler som forenkler det komplekse. Se min sanntids GitHub-aktivitet, akademiske reise og tekniske logger fra .NET til filosofi.', twitterImage: 'https://krigjo25.no/media/images/carousel/20240903_165612.jpg', themeColor: '#ffffff' } });
