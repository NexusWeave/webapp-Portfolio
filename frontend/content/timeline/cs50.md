...
subjects:
  - title: Introduction to Computer Science with Python
    body: |
      En dypdykk i datavitenskapens fundamenter med **Python** som hovedverktøy. Kurset dekker alt fra minnehåndtering i **C** til webutvikling med **JavaScrpt**, **Flask** og **SQL**. Jeg erfarte å skrive effektiv, lesbar kode og løse algoritmiske utfordringer.
