...
subjects:
  - title: Introduction to Computer Science with Python
    body: |
      En dypdykk i datavitenskapens fundamenter med **Python** som hovedverktøy. Kurset dekker alt fra minnehåndtering i **C** til webutvikling med **JavaScrpt**, **Flask** og **SQL**. Jeg erfare å skrive effektiv, lesbar kode og løse komplekse algoritmiske utfordringer.
    created: 2026-02-01T13:58:00.175Z
