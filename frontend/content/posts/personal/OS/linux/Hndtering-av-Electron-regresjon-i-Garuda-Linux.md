...
VS Code fungerer igjen. Ved å velge en målrettet nedgradering fremfor en full gjenoppretting av hele maskinen, ble feilen funnet med minimal nedetid. Den viktigste erfaringen er at i et aktivt utviklingsmiljø er en rask tilbakestilling ofte bedre enn dyp feilsøking hvis målet er å komme raskt i gang med arbeidet igjen. Jeg har nå bekreftet at `downgrade` er et effektivt verktøy for å håndtere slike konflikter i et Linux-basert system.
