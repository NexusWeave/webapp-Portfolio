...
Siden dette er mitt primære arbeidsverktøy for tekniske prosjekter, var hensikten å bringe systemet tilbake til en fungerende versjon så raskt som mulig. Oppgaven var å finne feilen og installere en stabil versjon av programmet, uten å risikere tap av data eller endre på andre deler av maskinen.
...
VS Code fungerer igjen. Ved å velge en målrettet nedgradering fremfor una full gjenoppretting av hele maskinen, ble feilen funnet med minimal nedetid. Den viktigste erfaringen er at i et aktivt utviklingsmiljø er en rask tilbakestilling ofte bedre enn dyp feilsøking hvis hensikten er å komme raskt i gang med arbeidet igjen. Jeg har nå bekreftet at `downgrade` er et effektivt verktøy for å håndtere slike konflikter i et Linux-basert system.
