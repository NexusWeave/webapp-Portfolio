...
Målet var å stabilisere systemet og sikre henting av relevante prosjekter. Utfordringen var å filtrere ut uvelkommende skoleprosjekter, uten at dette påvirket overvåkingen av relevante prosjekter. for å oppnå dette målet, utførte jeg en systematisk  serivice for Github-systemet:
...
Jeg har nå stabilisert systemet til et pålitelig og selvgående system, som kjører uten behov for manuelle avbrudd eller løpende feilsøking. Ved å kombinere stabilitet med logisk sortering, leveres dataene direkte til skylagring, noe som at all prosjektinformasjon er umiddelbart tilgjengelig ved uthenting. For å øke nytteverdien ytterligere har jeg laget et automatisk system for kategorisering med etiketter for backend, frontend og fullstack for hvert prosjekt. Dette forenkler filteringen for besøkende og gjør datasettet langt mer oversiktlig for videre analyse.