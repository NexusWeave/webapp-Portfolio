...
Målet mitt var å bygge om dette systemet ved hjelp av bransjestandarden **SQLAlchemy**. Oppgaven handlet om å standardisere hvordan data lagres og hentes, slik at systemet er pålitelig, forenkle den tiden det tar for at andre kan sette seg inn i koden, og klargjør tjenesten for fremtidig vekst.
...
* Med hjelp av Pyndandic-modeller har jeg  laget en felles mal for hvordan jeg legger til, leser eller sletter informasjon, som sikrer lik praksis i hele løsningen.
