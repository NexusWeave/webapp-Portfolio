...
Målet er at programmet skal kunne håndtere flere forespørsler samtidig og frigjøre ressurser etter behov. Oppgaven var å erstatte det nåværende verktøyet `requests` med et asynkront bibliotek som `httpx`.
