...
star: |
  ...
  * **Konfigurering** - Jeg opprettet en jobb i Google Cloud Scheduler med en frekvens på 0 0 1 \* \* Som betyr at denne oppgaven skal kjøres hver første dag i hver måned.
  * **Vertifisering** -  for å vertifisere at funksjonaliteten fungerte kjørte jeg en `force run` for å se om Oppgaven klarte å levere en GET-forespørsel til FastAPI-endepunktet.
