...
tags:
  - dev-journey
title: Strategisk Tilnærming til Kongnitiv Sperre
ingress: >
  Utviklingsarbeidet er for tiden preget av en kognitiv blokkering ("kode
  sperre"), som spesifikt hindrer effektiv fremdrift på testene. For å håndtere
  denne utfordringen ble det etablert en 48-timers observasjons- og
  inkubasjonsfase. Gjennom denne fasen ble tiden dedikert til passiv kognitiv
  inkubasjon og gjennomlesning av relevant fagstoff, med mål om å diagnostisere
