...
Målet var å få på plass en "Single Source of Truth" der bare de bearbeida dataene blir returnert. Jeg ville vise at backend kan ta fullt ansvar for transformasjonen så frontenden slipper å drive med tung logikk for å vise en enkel liste med språk.
