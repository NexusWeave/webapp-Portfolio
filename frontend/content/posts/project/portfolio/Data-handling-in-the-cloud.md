...
SQL-prosjektet mitt har kommet så langt at det var på tide med en skikkelig lansering, og da holdt det ikke lenger å bare ha databasen liggende lokalt. Jeg bestemte meg for å flytte alt over til Turso, som er en skybasert plattform som passer optimalt for utviklingsprosjekter uten at det koster skjorta.

Hensikten var å delegere ansvaret for infrastruktur og sikkerhet til proffene hos Turso, så jeg kan fokusere mer på selve koden istedenfor database-administrasjon. Men overgangen fra SQLite til libSQL førte med seg noen endringer i hvordan appen må kommunisere.
...
Gjennom dette arbeidet har jeg fått en mye dypere forståelse for hvordan SQLAlchemy fungerer under panseret, og ikke minst hvordan man veksler mellom synkron og asynkron kode avhengig av verktøyene man bruker. Nå ruller datakommunikasjonen stabilt mot skyen, og fundamentet er klart for produksjon.
