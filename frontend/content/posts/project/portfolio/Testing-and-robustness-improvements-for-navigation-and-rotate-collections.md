...
Testingen sikrer at prosjektet har en pålitelig navigasjons- og databehandlingslogikk som kjører stabilt på tvers av ulike kjøretidsmiljøer. Dette øker stabiliteten for nettsiden. Som en konsekvens av den nye teststrukturen blir endringer i navigasjons- og karusellfunksjonalitet validert.
...
1. **Hva skal denne funksjonen gjøre når alt går optimalt? (Den glade sti / Happy Path)**
