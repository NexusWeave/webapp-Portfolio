  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        '@graph': [
          {
            '@type': 'WebSite',
            '@id': 'https://krigjo25.no/#website',
            'url': 'https://krigjo25.no/',
            'name': 'Kristoffer Gjøsund - Portefølje',
            'description': 'Portefølje side for Kristoffer Gjøsund (krigjo25)',
            'inLanguage': 'nb-NO',
            'publisher': {
              '@type': 'Person',
          ...
          },
          {
            ...
            '@id': 'https://krigjo25.no/#navigation',
            'name': 'Hovedmeny',
            'hasPart': [
              {
                '@type': 'WebPage',
