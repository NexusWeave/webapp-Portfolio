...
import type { PostMeta } from '~/types/utils';
...
export interface PostItem extends DocumentItem { tags: PostTag[]; path: string; anchor: Anchor; date: DateItem; status: string; ingress: string; info?: string; sources?: string; image?: string; meta?: PostMeta; isArchived: boolean; isPublished: boolean; }
