...
export interface PostItem extends DocumentItem {  tags: PostTag[]; path: string;  anchor: Anchor; date: DateItem;  status: string; ingress: string; info?: string; sources?: string;  isArchived: boolean; isPublished: boolean; }
