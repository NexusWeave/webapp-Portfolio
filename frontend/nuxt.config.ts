...
export default defineNuxtConfig({
  ...
  site: { url: 'https://krigjo25.no', name: 'Kristoffer Gjøsund - Portfolio', gzip: true, exclude: [ '/admin/**' ], defaults: { priority: 0.7, changefreq: 'daily', autoLastmod: true, strictNuxtContentAds: true } },
  runtimeConfig:{
    public:{
