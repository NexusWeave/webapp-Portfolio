...
flowchart TD
    ...
    B -- 404 --> C1[AI cannot understand the message]
    C1 --> A[AI sends a response asking for clarification]
    B -- 200 --> C[Understands the message and looks up information from the database]
    C --> D[Does the information exist in Database?]
    D -- No (404 Not Found) --> D1[AI Scanns the webpage and generates]
